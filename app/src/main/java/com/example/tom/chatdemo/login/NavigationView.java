...
public class NavigationView extends LinearLayout {
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        image_height = typedArray.getInteger(R.styleable.NavigationView_image_height, 40);
        image_width = typedArray.getInteger(R.styleable.NavigationView_image_width, 40);
